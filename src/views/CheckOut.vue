      ...
      <v-row>
        <v-col cols="12" md="6" lg="7" class="order-1 order-md-0">
          ...
          >
            ...
            <v-card-actions class="mx-0 px-0">
              <v-btn color="#6200ff" variant="elevated" class="w-50">
                <svg
              ...
              <v-btn color="black" variant="elevated" class="w-50">
            ...
            <v-card-title
              class="pa-0 mt-7 font-weight-bold"
              style="font-size: 18px"
              >Shipping Addresses</v-card-title
            >
            <select
              class="w-100 py-2 px-4 mt-3"
              style="border: 1px solid; border-radius: 5px; font-size: 14px"
            >
              <option
                :value="country"
            ...
            <div class="mt-8">
              ...
              <v-divider length="100%" color="black"></v-divider>
              <v-card-subtitle class="mt-3 px-0"
                >All rights reserved new-ella-demo</v-card-subtitle
              >
            </div>
          </v-card>
        </v-col>
        ...
        >
          <v-card
            ...
            width="100%"
            class="checkout-col"
            style="background-color: #eee; padding: 60px 120px 0 40px"
          >
            <v-card
              ...
              :key="item.id"
              class="d-flex justify-center align-center text-start py-3 w-100"
            >
            ...
            <div class="d-flex justify-space-between">
              ...
              <v-card-text class="pr-4 text-end py-1"
            ...
            <div class="d-flex justify-space-between">
              <v-card-text
                class="pl-4 text-start py-1 font-weight-bold"
                style="font-size: 17px"
                >Total</v-card-text
              >
              <v-card-text
                class="pr-4 text-end py-1"
                style="font-size: 18px; font-weight: bold"
                ><span style="color: #999; font-size: 13px; margin-right: 10px"
                  >USD</span
                >
