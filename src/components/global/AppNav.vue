    ...
    <v-app-bar color="#02218f" height="fit-content" absolute>
      <v-container fluid>
        <v-row class="align-center">
          ...
          <v-col cols="4">
            <div
              class="search bg-white d-flex align-center px-3"
            ...
            >
              <input
                ...
                name="navSearch"
                id="navSearch"
                class="bg-white py-2 px-3"
                style="border-radius: 30px; outline: none; flex: 1"
          ...
          <v-col cols="5">
            <div
              class="icons d-flex justify-space-between align-center"
              style="font-size: 15px"
            >
              <div class="available">
                Available 24/7 at
                <p>(+90) 50 1336 25 11</p>
              </div>
              <div class="icon" style="cursor: pointer">
                <svg
                  viewBox="0 0 512 512"
                  class="icon icon-wishlist"
                  style="width: 22px; fill: #ffb548"
                >
                  <g>
                    <g>
                      <path
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
                ...
                <p style="color: #ffb548">Wish Lists</p>
              </div>
              <div class="icon" style="cursor: pointer">
                <svg
                ...
                <p style="color: #ffb548">Sign in</p>
              </div>
              <div
                class="icon mr-5"
              ...
              >
                ...
                <svg
                  viewBox="0 0 1024 1024"
                  xmlns="http://www.w3.org/2000/svg"
                  style="width: 22px; fill: #ffb548; cursor: pointer"
                  @click="openCart"
                >
                  <path
                    class="path1"
        ...
        <v-row class="mt-3 d-flex align-center">
          ...
          <v-col cols="4" class="d-flex justify-end" style="gap: 20px">
            <v-btn>
              <div class="help d-flex align-center" style="gap: 8px">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  class="svg-inline--fa fa-user-headset fa-w-14 fa-3x text-blue"
                  style="width: 22px"
                >
                  <path
                    fill="currentColor"
            ...
            <v-btn id="language-btn">
              <div class="lang d-flex align-center" style="gap: 8px">
            ...
            <v-menu activator="#language-btn" offset="10">
              <v-list v-model:selected="selectedLang" mandatory>
                <v-list-item v-for="lang in langs" :key="lang" :value="lang">
                  <v-list-item-title style="cursor: pointer">
                    <div style="display: flex; gap: 8px">
                      <span v-html="lang.icon" style="margin-top: 3px"></span>
  ...
  data: () => ({
    ...
    langs: [
      ...
      },
      {
        lang: "DE",
        currency: "EURO",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 512 512" style="width: 18px; enable-background:new 0 0 512 512;" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
