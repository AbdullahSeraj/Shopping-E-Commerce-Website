<template>
  <div class="quality bg-grey-lighten-2 py-10">
    <v-container fluid>
      <v-row>
        <v-col
          cols="12"
        ...
        >
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              height="350"
              class="px-3 w-100 d-flex align-center justify-center"
              v-bind="props"
              :color="`${isHovering ? 'blue-lighten-4' : 'white'}`"
              :elevation="`${isHovering ? 1 : 0}`"
              style="border-radius: 10px; cursor: pointer; transition: 0.3s"
            >
              <div class="parent">
  ...
  data: () => ({
    cards: [
      ...
      },
      {
        ...
        desc: "24/7 Customer Service - We're here adn happy to help!",
