    ...
    <v-container>
      <v-row>
        <v-col
          ...
          md="4"
          lg="4"
          class="d-flex align-center justify-center second flex-column flex-sm-row"
          style="gap: 10px"
        >
          <svg
            aria-hidden="true"
            ...
            viewBox="0 0 640 512"
            class="svg-inline--fa fa-shipping-fast fa-w-20 fa-3x mr-0 mr-sm-3"
            style="width: 32px"
          >
            <path
              fill="currentColor"
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
            class="svg-inline--fa fa-award fa-w-12 fa-3x mr-0 mr-sm-3"
            style="width: 26px"
          >
            <path
              fill="currentColor"
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 576 512"
            class="svg-inline--fa fa-trophy-alt fa-w-18 fa-3x mr-0 mr-sm-3"
            style="width: 32px"
          >
            <path
              fill="currentColor"
